...
interface LearningResourceSeed {
  ...
  provider: string;
  url: string;
  type: "COURSE" | "ARTICLE" | "VIDEO" | "DOCS" | "BOOK";
  level: "BEGINNER" | "INTERMEDIATE" | "ADVANCED";
  durationMinutes: number;
  description: string;
}

// A small, deliberately conservative catalog of real, well-known free resources —
// official docs and established free courses, not fabricated course titles. Coverage
// is intentionally partial: a skill with no matching resource here simply won't
// surface a recommendation, rather than showing a made-up one.
const LEARNING_RESOURCES: LearningResourceSeed[] = [
  {
    ...
    level: "BEGINNER",
    durationMinutes: 180,
    description: "Mozilla's official guide to the JavaScript language, from syntax basics through closures and async.",
  },
  {
    ...
    level: "BEGINNER",
    durationMinutes: 90,
    description: "The official TypeScript handbook covering the type system from the ground up.",
  },
  {
    skillName: "Python",
    ...
    level: "BEGINNER",
    durationMinutes: 240,
    description: "The official Python tutorial maintained by the Python core team.",
  },
  {
    skillName: "React",
    title: "Learn React",
    ...
    level: "BEGINNER",
    durationMinutes: 180,
    description: "React's official documentation and interactive tutorial for building UIs with components.",
  },
  {
    skillName: "Next.js",
    ...
    level: "INTERMEDIATE",
    durationMinutes: 300,
    description: "Vercel's official, free interactive course for building a full application with Next.js.",
  },
  {
    skillName: "Node.js",
    ...
    level: "BEGINNER",
    durationMinutes: 90,
    description: "The official Node.js guide to the runtime, modules, and the event loop.",
  },
  {
    skillName: "Git",
    title: "Pro Git",
    ...
    level: "BEGINNER",
    durationMinutes: 240,
    description: "The free, official Git book — everything from first commits to internals.",
  },
  {
    skillName: "SQL",
    ...
    level: "BEGINNER",
    durationMinutes: 300,
    description: "freeCodeCamp's free, hands-on curriculum for SQL and relational database design.",
  },
  {
    ...
    level: "INTERMEDIATE",
    durationMinutes: 120,
    description: "The official PostgreSQL documentation's getting-started tutorial.",
  },
  {
    skillName: "Docker",
    ...
    level: "BEGINNER",
    durationMinutes: 90,
    description: "Docker's official walkthrough of containers, images, and Dockerfiles.",
  },
  {
    ...
    level: "INTERMEDIATE",
    durationMinutes: 180,
    description: "The official Kubernetes documentation's hands-on tutorials.",
  },
  {
    skillName: "AWS",
    ...
    level: "BEGINNER",
    durationMinutes: 300,
    description: "AWS's own free digital training library, including cloud-practitioner fundamentals.",
  },
  {
    skillName: "Terraform",
    ...
    level: "INTERMEDIATE",
    durationMinutes: 120,
    description: "HashiCorp's official Terraform docs and tutorials for infrastructure as code.",
  },
  {
    ...
    level: "INTERMEDIATE",
    durationMinutes: 900,
    description: "Google's free, self-paced crash course covering ML fundamentals with TensorFlow exercises.",
  },
  {
    ...
    level: "BEGINNER",
    durationMinutes: 300,
    description: "Kaggle's free, hands-on micro-courses on data analysis, pandas, and visualization.",
  },
  {
    ...
    level: "INTERMEDIATE",
    durationMinutes: 600,
    description: "A widely-used, free open-source primer on designing large-scale systems.",
  },
  {
    skillName: "GraphQL",
    title: "Learn GraphQL",
    ...
    level: "BEGINNER",
    durationMinutes: 90,
    description: "The official introduction to GraphQL's type system, queries, and schemas.",
  },
  {
    skillName: "Linux",
    title: "Linux Journey",
    ...
    level: "BEGINNER",
    durationMinutes: 300,
    description: "A free, structured introduction to the Linux command line and system administration.",
  },
  {
    ...
    level: "BEGINNER",
    durationMinutes: 60,
    description: "Atlassian's free guide to Agile, Scrum, and Kanban fundamentals.",
  },
  {
    skillName: "Product Management",
    title: "Agile Coach: Product Management",
    provider: "Atlassian",
    url: "https://www.atlassian.com/agile/product-management",
    type: "ARTICLE",
    level: "BEGINNER",
    durationMinutes: 60,
    description: "Atlassian's free primer on product management fundamentals and roadmapping.",
  },
];
...
async function seedLearningResources() {
  ...
  for (const r of LEARNING_RESOURCES) {
    const skill = await prisma.skill.findUnique({ where: { name: r.skillName } });
    if (!skill) continue;

    const existing = await prisma.learningResource.findFirst({ where: { url: r.url, skillId: skill.id } });
    if (existing) {
