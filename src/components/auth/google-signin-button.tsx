...
/** The official Google "G" mark — lucide-react has no brand icons, and
    Google's own brand guidelines want the multicolor mark reproduced
    exactly, not recolored to match the app theme. */
function GoogleIcon() {
  return (
