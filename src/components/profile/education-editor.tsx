...
const EMPTY_FORM = { school: "", degree: "", fieldOfStudy: "", startDate: "", endDate: "", isCurrent: false, description: "" };

export function EducationEditor({ initial }: { initial: EducationItem[] }) {
  ...
  async function save() {
    ...
    try {
      ...
      const saved = json.data.education as EducationItem;
        ...
        <Card>
          <CardContent className="space-y-4 p-5">
            ...
            <div className="flex gap-2">
              <Button onClick={save} disabled={saving || !form.school}>
