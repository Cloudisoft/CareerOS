    ...
    <div className="mb-6 overflow-hidden rounded-xl border border-border">
      <div className="relative h-36 bg-brand-gradient sm:h-44">
        ...
        <ImagePickerButton
          ...
          className="absolute right-3 top-3 flex items-center gap-1.5 rounded-md bg-background/80 px-2.5 py-1.5 text-xs font-medium text-foreground backdrop-blur transition-colors hover:bg-background disabled:opacity-60"
        >
